...
class AddExperiences extends StatefulWidget {
  const AddExperiences({Key? key}) : super(key: key);
...
class _AddExperiencesState extends State<AddExperiences> {
  ...
  final TextEditingController _emplTypeController = TextEditingController();
      ...
      body: Column(
        children: [
          Expanded(
            child: SingleChildScrollView(
              child: Form(
                key: _formKey,
                child: Padding(
                  padding: EdgeInsets.only(top: 15 * height, left: 20 * width, right: 20 * width),
                  child: Column(
                    ...
                    children: [
                      ...
                      Textfieldd2(
                        ...
                        color: const Color(0xFF2D3D51),
                        weight: FontWeight.w400,
                        validator: (value) => value == null || value.isEmpty ? 'Please enter employment type' : null,
                      ),
                      Text(
                        'Company name',
                        style: TextStyle(
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          focusedBorder: OutlineInputBorder(
                            borderSide: const BorderSide(color: Color(0xFF2D3D51)),
                            borderRadius: BorderRadius.circular(5.0),
                          ),
                      ...
                      ElevatedButton(
                        ...
                        style: ButtonStyle(
                          ...
                          fixedSize: MaterialStateProperty.all(const Size(80, 5)),
          ...
          Padding(
            ...
            child: Consumer<SelectedStringModel>(
                ...
                return Mybuttons(
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      Navigator.pop(context);  // or any other action you want to perform after saving
                    }
                  },
                );
              },
